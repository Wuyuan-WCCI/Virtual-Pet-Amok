...
public class VirtualPetShelterApp {
    public static void main(String[] args) {
        ...
        shelter.addPet(new Robotic("AJohn", "Dog", "Robotic"));
        shelter.addPet(new Robotic("CJohn", "Dog", "Robotic"));
        ...
        while (!exit) {
            ...
            System.out.println("1. Feed all Organic pets(Don't feed Robotic pets)");
            System.out.println("2. Water all Organic pets(Don't water Robotic pets)");
            System.out.println("3. Play with a pet");
            System.out.println("4. Adopt a pet");
            System.out.println("5. Admit a pet. ");
            System.out.println("6. Oil all the Robotic pets(Don't oil Organic pets)");
            System.out.println("7. Clean all the dog cages. ");
            System.out.println("8. Clean the litter box.");
            System.out.println("9. Walking with all Organic Dogs.");
            ...
            switch (choice) {
                ...
                case 8:
                    ...
                    break;
                case 9:
                    shelter.walkingAllOrganicDogs();
                    break;
                case 10:
                    System.out
                            .println("Thank you for taking care of all the pets at the Virtual Pet Shelter! Goodbye! ");
                    exit = true;
                    break;
